...
The IEEE CDC 2026 entry, “Boundary-Seeking Policy Gradient for Safe Reinforcement Learning,” uses Figure 1 from https://arxiv.org/abs/2608.10204 (v1). `images/bspg-cdc2026-fig1.png` is the unmodified original figure from the arXiv HTML version, comparing local ESPO/BSPG update geometry on the feasible and infeasible sides of the constraint boundary. Title and author order follow arXiv; the conference and July 2026 acceptance date are confirmed by the author. A July news item and a BSPG tag under Safe Reinforcement Learning both link to the publication.
